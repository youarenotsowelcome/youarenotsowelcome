  ...
  return (
    <div className="page" style={{ background: '#0a0a0a', minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
      <div style={{ textAlign: 'center', padding: '40px', background: 'rgba(255,255,255,0.05)', borderRadius: '16px', border: '1px solid #333' }}>
        ...
        <p style={{ color: '#aaa', fontSize: '15px', lineHeight: '1.8', marginBottom: '32px' }}>Also it took me some expenses to buy a domain for my website. If you liked this game of decipher, I would be obliged if the winners could contribute a liitle. Contribution of 20-30 Rs will be appreciated</p>
